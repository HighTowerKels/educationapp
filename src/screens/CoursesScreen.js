...
const handleClassProfile = () =>{
  navigation.navigate('ClassProfileScreen')
}
    ...
    <View style={[styles.card, { backgroundColor: item.backgroundColor, borderTopWidth:4, borderTopColor: item.titleColor}]}>
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.buttonsContainer}>
          <TouchableOpacity style={styles.actionButton} onPress={handleClassProfile}>
...
<View style={styles.buttonContainer}>
                ...
                {/* You can adjust the style of BackButton to match your BackButton component */}
            </View>
